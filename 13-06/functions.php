...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('feadturedBlog', 1280, 444, true);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('slickNav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.4'); // PictureFill
...
function html5blank_styles()
{
    ...
    wp_register_style('pontanoFont', 'http://fonts.googleapis.com/css?family=Pontano+Sans', array(), '1.0', 'all');
