...
function lapizzeria_custom_logo() {
 ...
 add_theme_support( "custom_logo", $logo );
}
...
function lapizzeria_styles() {
 ...
 $api_key = esc_html( get_option("lapizzeria_gmap_apikey") );
    ...
    wp_register_script("googlemaps", 'https://www.googleapis/maps/api/js?key="' . $api_key .'"&callback=initMap',array(), "", true);
    wp_register_script("datetime-local-polyfill", get_template_directory_uri("jquery"). "/js/datetime-local-polyfill.min.js" ,array("jquery","jquery-ui-core","jquery-ui-datepicker","modernizr"), "", true);
